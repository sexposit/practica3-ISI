describe('PlayersService', function () {
  ...
  describe('removePlayer', function () {
    it('should remove player with the given id', function () {
      var playerId = 1;
  ...
  describe('getPlayer', function () {
    it('should ask for the player with the given id and return it', function () {
      ...
      console.log(PlayersService.getPlayer(playerId))
  ...
  describe('unrewardPlayer', function () {
    it('should take 5 points to the player score with the given id', function () {
      var playerId = 1;
      spyOn(Players, 'update');

      PlayersService.unrewardPlayer(playerId);
      expect(Players.update.calls.argsFor(0)).toEqual([playerId, {$inc: {score: -5}}]);
    });
  });
